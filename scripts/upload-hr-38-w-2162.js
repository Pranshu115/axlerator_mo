...
// Try to use service role key from env if available, otherwise use anon key
...
const FOLDER_NAME = 'HR 38 W 2162'
...
async function main() {
  ...
  // Save mapping file
  const mappingFile = path.join(__dirname, '..', 'hr-38-w-2162-upload-mapping.json')
